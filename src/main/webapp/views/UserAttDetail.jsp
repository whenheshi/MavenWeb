...
<body>
	<div class="title">签到信息(考勤数据最后更新日期:${lastDate})
	...
	<div style="width:100%">
		<table id="conditionTable" url="findUserAttDetailPage.do">
			<tr>
				<td class="lableTd">姓名:</td>
				<td><input type="text" name="name" value="${name}"></td>
				<td class="lableTd">部门:</td>
				<td><input type="text" name="dept" value="${dept}"></td>
				<td class="lableTd">签到日期:</td>
				<td><input type="text" id="dateBegin" name="dateBegin" onfocus="WdatePicker({vel:'endDay',readOnly:true,firstDayOfWeek:1})" class="Wdate"/></td>
				<td class="lableTd">至</td>
				<td><input type="text" id="dateEnd" name="dateEnd" onfocus="WdatePicker({vel:'dateEnd',readOnly:true,firstDayOfWeek:1})" class="Wdate"/></td>
		...
		<table id="resultTable" class="table">
			<thead>
				<tr>
					...
					<th class="dept">部门</th>
					<th class="job">职位</th>
					<th class="code">工号/员工ID</th>
					<th class="dateStr">日期</th>
					<th class="timeStr">签到时间</th>
					<th class="addr">签到地点</th>
				</tr>
			</thead>
			<tbody>
			</tbody>
